		...
		>
				...
				<div>
					{!session ? (
						<button
							...
							className="flex items-center px-4 py-2 text-sm text-white rounded bg-netflix-red"
						>
							Sign In
						</button>
					) : (
			...
			<main className="flex flex-col items-center justify-center flex-1 w-full px-20 text-center">
				...
				<div className="flex mt-4">
					...
					/>
					<button className="flex items-center px-8 text-xl text-white bg-netflix-red">
						Get Started
						<svg
							xmlns="http://www.w3.org/2000/svg"
							className="w-6 h-6"
